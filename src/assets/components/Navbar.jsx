  ...
  return (
    ...
    <SignUpSuccess />
      <div className="relative">
        ...
        >
          <div className="desktop:pt-[2.21rem] desktop:ps-[1.99rem] desktop:pe-[2.01rem] desktop:pb-[4.69rem] tablet:ps-[1.5rem] tablet:pt-[1.5rem] tablet:pb-[1.4rem] tablet:pe-[13.56rem] phone:py-[1.13rem] phone:ps-[1rem]">
