...
const StrengthPassword = ({ register, errors }) => {
  ...
  return (
    <div className="relative">
      <input
        aria-label="Password"
        aria-description="Please enter your password here, it must be 8 to 50 characters long, 1 lowercase letter,1 uppercase letter, one special symbol and one number"
        aria-required="true"
      ...
      {passwordStrength > 0 && (
        <div className="mb-2">
          ...
          <div className="text-sm mt-1 text-figma-white">
