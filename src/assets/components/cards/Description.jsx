        ...
        <AnimationRouteModal>
          {({ onClose }) => (
            <div className="relative">
              <div className="fixed inset-0 bg-black z-40 bg-opacity-50 flex justify-center items-center">
                <div className="desktop:min-w-[40rem] tablet:min-w-[30rem] phone:min-w-[20rem] w-[30vw] ">
                  <div className="bg-figma-semi-dark-blue text-figma-white rounded-t-3xl rounded-b-3xl rounded shadow-2xl shadow-figma-red ">
                    <div className="relative">
                      ...
                      <div
                        className="absolute top-[1.60rem] right-8"
                        onClick={onClose}
                      >
                        <CloseDescription />
                      </div>
                    </div>
                    <p className="text-center figma-heading-l border-x-2 pt-[1rem] break-words">
                      {show.title}
                    </p>
